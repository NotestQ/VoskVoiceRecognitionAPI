 ...
 *
 *   A copy of the license is located in the "VOICEPROCESSOR-LICENSE" file accompanying this source.
 *   
 ...
 *
 * 2024 - Notest
 * Custom exceptions switched to regular exceptions as the VoiceProcessorException.cs file is not included.
 * Clarified exception messages by including "VoiceProcessor"
 *
 * * * * */
    ...
    public class VoiceProcessor : MonoBehaviour
    {
        ...
        public void UpdateDevices()
        {
            ...
            if (Devices == null || Devices.Count == 0)
            {
                ...
                throw new Exception(
                    "VoiceProcessor: There is no valid recording device connected");
            }
        ...
        public void ChangeDevice(int deviceIndex)
        {
            ...
            {
                throw new Exception(
                    string.Format("VoiceProcessor: Specified device index {0} is not a valid recording device", deviceIndex));
            }
